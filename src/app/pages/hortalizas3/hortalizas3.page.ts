...
import { Hortalizas3 } from '../../interfaces/hortalizas3';
import { HORTALIZAS3 } from '../../data/data.hortalizas2';

@Component({
  selector: 'app-hortalizas3',
  templateUrl: './hortalizas3.page.html',
  styleUrls: ['./hortalizas3.page.scss'],
})
export class Hortalizas3Page implements OnInit {
  ...
  ngOnInit() {
    this.cultivo = HORTALIZAS3.slice(0);
