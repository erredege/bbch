...
import { Colza } from '../../interfaces/colza';
import { COLZA} from '../../data/data.colza';

@Component({
  selector: 'app-colza',
  templateUrl: './colza.page.html',
  styleUrls: ['./colza.page.scss'],
})
export class ColzaPage implements OnInit {
