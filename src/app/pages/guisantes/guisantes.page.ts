...
import { Guisantes } from '../../interfaces/guisantes';
import { GUISANTES } from '../../data/data.guisantes';

@Component({
  selector: 'app-guisantes',
  templateUrl: './guisantes.page.html',
  styleUrls: ['./guisantes.page.scss'],
})
export class GuisantesPage implements OnInit {
  ...
  ngOnInit() {
    this.cultivo = GUISANTES.slice(0);
