...
import { Maiz} from '../../interfaces/maiz';
import { MAIZ } from '../../data/data.maiz';

@Component({
  selector: 'app-maiz',
  templateUrl: './maiz.page.html',
  styleUrls: ['./maiz.page.scss'],
})
export class MaizPage implements OnInit {
