...
import { Grosellero } from '../../interfaces/grosellero';
import { GROSELLERO } from '../../data/data.grosellero';

@Component({
  selector: 'app-grosellero',
  templateUrl: './grosellero.page.html',
  styleUrls: ['./grosellero.page.scss'],
})
export class GroselleroPage implements OnInit {
  ...
  ngOnInit() {
    this.cultivo = GROSELLERO.slice(0);
