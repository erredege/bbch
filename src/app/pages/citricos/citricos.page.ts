...
import { Citricos } from '../../interfaces/citricos';
import { CITRICOS } from '../../data/data.citricos';

@Component({
  selector: 'app-citricos',
  templateUrl: './citricos.page.html',
  styleUrls: ['./citricos.page.scss'],
})
export class CitricosPage implements OnInit {
