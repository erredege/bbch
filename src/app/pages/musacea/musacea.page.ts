...
import { MUSACEA } from '../../data/data.musacea';
import { Musacea } from '../../interfaces/musacea';

@Component({
  selector: 'app-musacea',
  templateUrl: './musacea.page.html',
  styleUrls: ['./musacea.page.scss'],
})
export class MusaceaPage implements OnInit {
