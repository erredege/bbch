...
import { Remolacha } from '../../interfaces/remolacha';
import { REMOLACHA } from '../../data/data.remolacha';

@Component({
  selector: 'app-remolacha',
  templateUrl: './remolacha.page.html',
  styleUrls: ['./remolacha.page.scss'],
})
export class RemolachaPage implements OnInit {
  ...
  ngOnInit() {
    this.cultivo = REMOLACHA.slice(0);
