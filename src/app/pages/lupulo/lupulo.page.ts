...
import { Lupulo } from '../../interfaces/lupulo';
import { LUPULO } from '../../data/data.lupulo';

@Component({
  selector: 'app-lupulo',
  templateUrl: './lupulo.page.html',
  styleUrls: ['./lupulo.page.scss'],
})
export class LupuloPage implements OnInit {
