...
import { Verduras1 } from '../../interfaces/verduras1';
import { VERDURAS1 } from '../../data/data.verduras1';

@Component({
  selector: 'app-verduras1',
  templateUrl: './verduras1.page.html',
  styleUrls: ['./verduras1.page.scss'],
})
export class Verduras1Page implements OnInit {
  ...
  ngOnInit() {
    this.cultivo = VERDURAS1.slice(0);
