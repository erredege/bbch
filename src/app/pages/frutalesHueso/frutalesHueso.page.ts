...
import { FrutalesHueso } from '../../interfaces/frutalesHueso';
import { FRUTALESHUESO } from '../../data/data.frutalesHueso';

@Component({
  selector: 'app-frutalesHueso',
  templateUrl: './frutalesHueso.page.html',
  styleUrls: ['./frutalesHueso.page.scss'],
})
export class FrutalesHuesoPage implements OnInit {
  ...
  ngOnInit() {
    this.cultivo = FRUTALESHUESO.slice(0);
