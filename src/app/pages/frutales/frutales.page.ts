...
import { Frutales } from '../../interfaces/frutales';
import { FRUTALES } from '../../data/data.frutales';

@Component({
  selector: 'app-frutales',
  templateUrl: './frutales.page.html',
  styleUrls: ['./frutales.page.scss'],
})
export class FrutalesPage implements OnInit {
