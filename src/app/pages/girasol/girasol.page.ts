...
import { Girasol } from '../../interfaces/girasol';
import { GIRASOL } from '../../data/data.girasol';

@Component({
  selector: 'app-girasol',
  templateUrl: './girasol.page.html',
  styleUrls: ['./girasol.page.scss'],
})
export class GirasolPage implements OnInit {
