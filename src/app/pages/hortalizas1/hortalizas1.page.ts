...
import { Hortalizas1 } from '../../interfaces/hortalizas1';
import { HORTALIZAS1 } from '../../data/data.hortalizas3';

@Component({
  selector: 'app-hortalizas1',
  templateUrl: './hortalizas1.page.html',
  styleUrls: ['./hortalizas1.page.scss'],
})
export class Hortalizas1Page implements OnInit {
  ...
  ngOnInit() {
    this.cultivo = HORTALIZAS1.slice(0);
